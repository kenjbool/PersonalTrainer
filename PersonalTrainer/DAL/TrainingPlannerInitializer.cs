...
namespace PersonalTrainer.DAL
{
    public class TrainingPlannerInitializer : System.Data.Entity. DropCreateDatabaseIfModelChanges<TrainingPlannerContext>
    {
        protected override void Seed(TrainingPlannerContext context)
        {
            ...
            {
                new FitnessTest { ClientNum= 1, ClientId = "12134525", ExerciseName = "Squat", WeightLifted = 60, Reps = 10, ORM = 90.45, TRM = 86.45, Comments = "fatigued"},
                new FitnessTest { ClientNum= 2, ClientId = "12134525", ExerciseName = "Pull ups", WeightLifted = 20, Reps = 10, ORM = 33.25, TRM = 26.45, Comments = "strong back"},
                new FitnessTest { ClientNum= 3, ClientId = "25160526", ExerciseName = "Squat", WeightLifted = 60, Reps = 10, ORM = 90.45, TRM = 86.45, Comments = "fatigued"},
                new FitnessTest { ClientNum= 4, ClientId = "25160526", ExerciseName = "Pull ups", WeightLifted = 20, Reps = 10, ORM = 33.25, TRM = 26.45, Comments = "strong back"},
            };
